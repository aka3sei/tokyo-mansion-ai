...
ku_details = {
    ...
    '板橋区': "「三田線による都心直通の利便性と、加賀エリアの歴史ある住環境が魅力。住みやすさへの満足度が高いエリアです。」\n【人気エリア】加賀、成増、板橋、志村坂上\n【ブランド】パークホームズ、プラウド、加賀レジデンス\n【補足】「加賀」エリアは加賀藩下屋屋敷跡の歴史があり別格。子育て世代からの支持も非常に安定しています。",
...
if st.button("AI査定を実行する"):
    ...
    st.info(f"✨ **ブランド期待価格レンジ**: {int(price_base*1.0):,} 〜 {int(price_base*1.2):,} 万円")
